...
<head>
	...
	<title>Data Innovation - AI content Automation System</title>
</head>
<body class="">
    <!--wrapper-->
    <div class="wrapper">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
                            <div class="card-body">
                                <img style="    transform: matrix(1, 0, 0, 1, 0, 0) !important;"src="assets/images/login-images/login-bg.png" class="img-fluid auth-img-cover-login" width="650" alt=""/>
                            </div>
                        </div>
                    </div>
