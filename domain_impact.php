...
$sql = "SELECT sending_domains.id, sending_domains.domain, sending_domains.company, sending_domains.countries, companies.name AS company_name FROM sending_domains LEFT JOIN companies ON sending_domains.company = companies.id";
$result = $conn->query($sql);
