...
$sql = "SELECT users.name AS user_name, companies.name AS company_name 
        FROM users 
        JOIN companies ON users.company = companies.id 
        WHERE users.id = ?";
        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    <li class="nav-item dropdown dropdown-language d-none d-sm-flex">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown"><img src="assets/images/county/05.png" width="22" alt=""></a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="assets/images/county/es.png" width="20" alt=""><span class="ms-2">Spanish </span></a></li>
                        </ul>
                    </li>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/user-avatar.png" class="user-img" alt="user avatar">
                    <div class="user-info">
